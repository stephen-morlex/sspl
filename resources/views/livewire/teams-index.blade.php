<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold text-left mb-8">Football Teams</h1>
        ...
        @elseif(isset($teams))
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach($teams as $team)
                    <a href="{{ route('teams.show', $team->id) }}" class="card card-bordered shadow bg-neutral  flex  hover:shadow-sm transition-all duration-300 transform hover:-translate-y-1">
